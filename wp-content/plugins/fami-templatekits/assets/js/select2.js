(function ($) {
	...
	jQuery(window).on('elementor:init', function () {
		var Fmtpl_ControlQueryPostSearch = elementor.modules.controls.BaseData.extend({
			...
			getPostTitlesbyID: function () {
				...
				var default_value = {
					security: fmtpl_var.select2Secret,
		...
		elementor.addControlView('fmtpl-select2', Fmtpl_ControlQueryPostSearch);
	});
})(jQuery);
