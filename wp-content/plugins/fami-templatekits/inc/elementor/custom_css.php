...
class Fmtpl_Custom_Css {
    ...
    public static function add_controls_section($element, $section_id, $args) {
        if ($section_id == 'section_custom_css_pro') {
            ...
            $element->start_controls_section(
                'section_fmtpl_custom_css',
                [
                    'label' => __( 'FM Custom CSS', 'fami-templatekits' ),
            ...
            $element->add_control(
                'custom_css_title',
                [
                    'raw' => __( 'Add your own custom CSS here', 'fami-templatekits' ),
            ...
            $element->add_control(
                ...
                [
                    ...
                    'label' => __( 'Custom CSS', 'fami-templatekits' ),
                    'language' => 'css',
                    'render_type' => 'ui',
                    'show_label' => false,
                    'separator' => 'none',
            ...
            $element->add_control(
                ...
                [
                    'raw' => __( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'fami-templatekits' ),
                    'type' => Controls_Manager::RAW_HTML,
    ...
    public function enqueue_editor_scripts() {
        wp_enqueue_script('fmtpl-editor-support-js', FAMI_TPL_URL.'assets/js/editor-support.js', array('jquery'), FAMI_TPL_VER, true);
    }

}
new Fmtpl_Custom_Css();