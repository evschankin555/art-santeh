...
/**
 * Elementor images gallery widget.
 *
 * Elementor widget that displays a set of images in an aligned grid.
 *
 * @since 1.0.0
 */
class Fmtpl_Images_Gallery extends Widget_Base {
	...
	public function get_title() {
		return __( 'Images Gallery', 'fami-templatekits' );
	}
	...
	public function get_icon() {
        return 'eicon-gallery-justified fmtpl-widget-icon';
	}
	...
	public function get_keywords() {
		return ['fami','fm', 'image', 'photo', 'visual', 'gallery' ];
	}
    ...
    protected function _register_controls() {
        $this->start_controls_section( 'settings', [ 'label' => __( 'Settings', 'fami-templatekits' ) ] );

        $this->add_control(
            'gallery_type',
            [
                'type' => Controls_Manager::SELECT,
                'label' => __( 'Type', 'fami-templatekits' ),
                'default' => 'single',
                'options' => [
                    'single' => __( 'Single', 'fami-templatekits' ),
                    'multiple' => __( 'Multiple', 'fami-templatekits' ),
                ],
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'New Gallery', 'fami-templatekits' ),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'label' => __( 'Galleries', 'fami-templatekits' ),
                'fields' => $repeater->get_controls(),
                'title_field' => '{{{ gallery_title }}}',
                'default' => [
                    [
                        'gallery_title' => __( 'New Gallery', 'fami-templatekits' ),
                    ],
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    '' => __( 'Default', 'fami-templatekits' ),
                    'random' => __( 'Random', 'fami-templatekits' ),
                ],
                'default' => '',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label' => __( 'Lazy Load', 'fami-templatekits' ),
                'return_value' => 'yes',
                'default' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'grid',
                'options' => [
                    'grid' => __( 'Grid', 'fami-templatekits' ),
                    'justified' => __( 'Justified', 'fami-templatekits' ),
                    'masonry' => __( 'Masonry', 'fami-templatekits' ),
                ],
                'separator' => 'before',
                'frontend_available' => true,
            ]
        ...
        $this->add_responsive_control(
            'ideal_row_height',
            [
                'label' => __( 'Row Height', 'fami-templatekits' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'file' => __( 'Media File', 'fami-templatekits' ),
                    'custom' => __( 'Custom URL', 'fami-templatekits' ),
                ],
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'url',
            [
                'label' => __( 'URL', 'fami-templatekits' ),
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::SELECT,
                'label' => __( 'Aspect Ratio', 'fami-templatekits' ),
                'default' => '3:2',
                'options' => [
                    '1:1' => '1:1',
                    '3:2' => '3:2',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Filter Bar', 'fami-templatekits' ),
                'condition' => [
                    'gallery_type' => 'multiple',
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::SWITCHER,
                'label' => __( '"All" Filter', 'fami-templatekits' ),
                'default' => 'yes',
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label' => __( '"All" Filter Label', 'fami-templatekits' ),
                'default' => __( 'All', 'fami-templatekits' ),
                'condition' => [
        ...
        $this->add_control(
            'pointer',
            [
                'label' => __( 'Pointer', 'fami-templatekits' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'underline',
                'options' => [
                    'none' => __( 'None', 'fami-templatekits' ),
                    'underline' => __( 'Underline', 'fami-templatekits' ),
                    'overline' => __( 'Overline', 'fami-templatekits' ),
                    'double-line' => __( 'Double Line', 'fami-templatekits' ),
                    'framed' => __( 'Framed', 'fami-templatekits' ),
                    'background' => __( 'Background', 'fami-templatekits' ),
                    'text' => __( 'Text', 'fami-templatekits' ),
                ],
                'style_transfer' => true,
            ]
        );
        ...
        $this->add_control(
            'animation_line',
            [
                'label' => __( 'Animation', 'fami-templatekits' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'fade',
                'options' => [
                    'fade' => 'Fade',
        ...
        $this->start_controls_section( 'overlay', [ 'label' => __( 'Overlay', 'fami-templatekits' ) ] );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'caption' => __( 'Caption', 'fami-templatekits' ),
                    'alt' => __( 'Alt', 'fami-templatekits' ),
                    'description' => __( 'Description', 'fami-templatekits' ),
                ],
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'image_border_width',
            [
                'label' => __( 'Border Width', 'fami-templatekits' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', 'em' ],
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Hover Animation', 'fami-templatekits' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => 'None',
                    'grow' => 'Zoom In',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Animation Duration', 'fami-templatekits' ) . ' (ms)',
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 800,
                ],
        ...
        $this->add_control(
            'image_blend_mode',
            [
                'label' => __( 'Blend Mode', 'fami-templatekits' ),
                'type' => Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                    '' => __( 'Normal', 'fami-templatekits' ),
                    'multiply' => 'Multiply',
                    'screen' => 'Screen',
                    'overlay' => 'Overlay',
                    'darken' => 'Darken',
        ...
        $this->add_control(
            ...
            [
                ...
                'groups' => [
                    [
                        'label' => __( 'None', 'fami-templatekits' ),
                        'options' => [
                            '' => __( 'None', 'fami-templatekits' ),
                        ],
                    ],
                    [
                        'label' => __( 'Entrance', 'fami-templatekits' ),
                        'options' => [
                    ...
                    [
                        'label' => __( 'Exit', 'fami-templatekits' ),
                        'options' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'groups' => [
                    ...
                    [
                        'label' => __( 'Reaction', 'fami-templatekits' ),
                        'options' => [
                            'grow' => 'Grow',
                            'shrink' => 'Shrink',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Sequenced Animation', 'fami-templatekits' ),
                'type' => Controls_Manager::SWITCHER,
                'condition' => [
                    'content_hover_animation!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Align', 'fami-templatekits' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'left' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-gallery__titles-container' => 'justify-content: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Pointer Color', 'fami-templatekits' ),
                'type' => Controls_Manager::COLOR,
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-gallery__titles-container:not(.e--pointer-framed) .elementor-item:before,
					{{WRAPPER}} .fmtpl-gallery__titles-container:not(.e--pointer-framed) .elementor-item:after' => 'background-color: {{VALUE}}',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-gallery__titles-container:not(.e--pointer-framed) .elementor-item.elementor-item-active:before,
					{{WRAPPER}} .fmtpl-gallery__titles-container:not(.e--pointer-framed) .elementor-item.elementor-item-active:after' => 'background-color: {{VALUE}}',
        ...
        $this->add_control(
            'pointer_width',
            [
                'label' => __( 'Pointer Width', 'fami-templatekits' ),
                'type' => Controls_Manager::SLIDER,
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-gallery__titles-container' => 'margin-bottom: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        if ( $is_multiple ) {
            $this->add_render_attribute( 'titles-container', 'class', 'fmtpl-gallery__titles-container' );
            ...
            <div <?php echo $this->get_render_attribute_string( 'titles-container' ); ?>>
                <?php if ( $settings['show_all_galleries'] == 'yes' ) { ?>
