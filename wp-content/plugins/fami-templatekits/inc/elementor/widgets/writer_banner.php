...
class Fmtpl_Writer_Banner extends Widget_Base
{
    private $default_control;

    public function get_name()
    {
        return 'fmtpl-writer-banner';
    }

    public function get_title()
    {
        return __('Type Writer Banner', 'fami-templatekits');
    }

    public function get_icon()
    {
        return 'fmtpl-type-writing fmtpl-widget-icon';
    }
    ...
    public function __construct( $data = [], $args = null ) {
        ...
        $this->add_style_depends('fmtpl-writer-banner');
    }
    ...
    private function define_widget_control()
    {
        $widget_control = [
            ...
            'height' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ],
            'overlay' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-overlay' => 'background-color: {{VALUE}};',
                ],
            ],
            'overlay_hover' => [
                'label' => __( 'Background Color', 'fami-templatekits' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner:hover .fmtpl-writer-banner-overlay' => 'background-color: {{VALUE}};',
                ],
            ],
            'image' => [
...
sit amet consectetur adipiscing', 'fami-templatekits' ),
            ...
            'text_alignment' => [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-content' => 'text-align: {{VALUE}}',
                ],
            ],
            ...
            'box_width' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-content' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ],
            'box_height' => [
                'label' => __( 'Height', 'fami-templatekits' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-content' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ],
            'content_alignment' => [
                'label' => __('Alignment', 'fami-templatekits'),
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-content' => 'background-color: {{VALUE}};',
                ],
            ],
            'horizontal_position' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner' => 'justify-content: {{VALUE}}',
                ],
            ],
            'vertical_position' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner' => 'align-items: {{VALUE}}',
                ],
            ...
            'box_margin' => [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ],
            'box_padding' => [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ],
            ...
            'border' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-content',
            ],
            ...
            'border_radius' => [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ],
            ...
            'title_bottom_space' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ],
            'title_color' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-title' => 'color: {{VALUE}};',
                ],
                'scheme' => [
            ...
            'title_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-title',
            ...
            'highlight_title_color' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-title .highlight' => 'color: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'highlight_title_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-title .highlight',
                'scheme' => Schemes\Typography::TYPOGRAPHY_1,
            ],
            ...
            'sub_title_color' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-sub-title' => 'color: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'sub_title_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-sub-title',
                'scheme' => Schemes\Typography::TYPOGRAPHY_1,
            ],
            'sub_title_bottom_space' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-sub-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ],
            'desc_bottom_space' => [
                'label' => __( 'Spacing', 'fami-templatekits' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .banner-desc' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ],
            'desc_color' => [
                'label' => __( 'Color', 'fami-templatekits' ),
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .banner-desc' => 'color: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'desc_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-writer-banner .banner-desc',
            ...
            'btn_width' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-button' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ],
            'btn_height' => [
                'label' => __( 'Height', 'fami-templatekits' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-button' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ],
            ...
            'btn_color' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-button' => 'color: {{VALUE}};fill:  {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'btn_color_hover' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-button:hover' => 'color: {{VALUE}};fill:  {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'btn_bg_color' =>
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-button' => 'background-color: {{VALUE}};',
                    ],
                ],
            'btn_bg_color_hover' =>
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-button:hover' => 'background-color: {{VALUE}};',
                    ],
                ],
            'btn_border' => [
                'name' => 'btn_border',
                'label' => __( 'Border', 'fami-templatekits' ),
                'selector' => '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-button',
            ],
            ...
            'btn_border_radius' => [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ],
            'btn_border_color_hover' => [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-button:hover' => 'border-color: {{VALUE}};',
                ],
                'condition' => [
                    'btn_border_border!' => '',
                ],
            ...
            'divider_width' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner-content .fmtpl-divider' => 'width: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'show_divider' => 'yes'
                ]
            ...
            'divider_height' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner-content .fmtpl-divider' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'show_divider' => 'yes'
                ]
            ...
            'divider_color' => [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner-content .fmtpl-divider' => 'background-color: {{VALUE}};',
                ],
                'default' => '#000000',
                'condition' => [
                    'show_divider' => 'yes'
            ...
            'divider_margin' => [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner-content .fmtpl-divider' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'show_divider' => 'yes'
                ]
            ...
            'divider_border_type' => [
                ...
                'label' => __( 'Border', 'fami-templatekits' ),
                'selector' => '{{WRAPPER}} .fmtpl-writer-banner-content .fmtpl-divider',
                'condition' => [
                    'show_divider' => 'yes'
                ]
            ],
            'divider_border_radius' => [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner-content .fmtpl-divider' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'show_divider' => 'yes'
                ]
            ...
            'divider_border_color_hover' => [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner-content .fmtpl-divider:hover' => 'border-color: {{VALUE}};',
                ],
                'conditions' => [
                    'relation' => 'and',
                    'terms' => [
            ...
            'item_title_bottom_space' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner-content .txt-rotate' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ],
            ...
            'item_title_color' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner-content .txt-rotate' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .fmtpl-writer-banner-content .txt-rotate > .wrap' => 'border-color: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'item_title_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-writer-banner-content .txt-rotate',
                'scheme' => Schemes\Typography::TYPOGRAPHY_1,
            ],
            ...
            'btn_icon_space' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-button.left .fmtpl-btn-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-writer-banner-button.right .fmtpl-btn-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
            ...
            'btn_icon_size' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-btn-icon' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
            ...
            'btn_text_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-writer-banner .fmtpl-btn-text',
            ]
        ];
        $this->default_control = apply_filters('fmtpl-writer-banner-elementor-widget-control', $widget_control);
    }
    ...
    protected function _register_controls()
    {
        ...
        if (sizeof($repeater->get_controls())> 1) {
            $this->start_controls_section(
                'section_writer',
                [
                    'label' => __( 'Type Writing', 'fami-templatekits' ),
            ...
            $this->add_control(
                'writing',
                [
                    'label' => __( 'Writing Text', 'fami-templatekits' ),
    ...
    protected function get_repeater_defaults() {
        ...
        return [
            [
                'item_title' => 'Proin eget tortor risus.',
            ],
            [
                'item_title' => 'Sed porttitor lectus nibh. Proin eget tortor risus.',
            ],
        ];
    }
    ...
    protected function fmtpl_render() {
        ...
        $txt_rotate = [];
        if (isset($settings['writing']) && !empty($settings['writing'])){
            foreach ($settings['writing'] as $w_item){
                $i_text = isset($w_item['item_title'])? $w_item['item_title']:'';
                $txt_rotate[]  = $i_text;
            }
        }
        $settings['txt_rotate'] = $txt_rotate;
        $html = apply_filters('fmtpl-writer-banner-elementor-widget-control_html','',$settings);
        if (!empty($html)){
            return $html;
        }
        $html = '<div class="fmtpl-elementor-widget fmtpl-writer-banner '.$settings['layout'].'">';
        if ( ! empty( $style_str ) ) {
            $html .= '<div class="fmtpl-writer-banner-background" '.$style_str.'></div>';
        }

        if (isset($settings['overlay']) && !empty($settings['overlay']) || (isset($settings['overlay_hover']) && !empty($settings['overlay_hover']))) {
            $html .= '<div class="fmtpl-writer-banner-overlay"></div>';
        }
        if ($settings['image_html'] != ''){
            if ((!isset($settings['button_text']) && !isset($settings['button_icon'])) ||
                ...
                if ($settings['link_attr_str'] != ''){
                    $html .= '<figure class="fmtpl-writer-banner-box-img has-link"><a class="banner-img-link" '.$settings['link_attr_str'].'>' . $settings['image_html'] . '</a></figure>';
                } else {
                    $html .= '<figure class="fmtpl-writer-banner-box-img">' . $settings['image_html'] . '</figure>';
                }
                //$content_html .= '<a class="fmtpl-button-default fmtpl-writer-banner-button '.$btn_class.'" ' . $link_attr_str . '>'.$icon_str.'<span class="fmtpl-btn-text">'.$settings['button_text'].'</span></a>';
        ...
        if (isset($settings['title_text'])) {
            ...
            $content_html .= '<div class="fmtpl-widget-title fmtpl-writer-banner-title ">'.$title.'</div>';
        }
        if (isset($settings['sub_title']) && !empty($settings['sub_title'])){
            $content_html .= '<div class="fmtpl-sub-title">'.$settings['sub_title'].'</div>';
        }
        if (!empty($txt_rotate)){
            $content_html .= '<div class="txt-rotate" data-period="2000" data-rotate="'.base64_encode(json_encode($txt_rotate)).'"></div>';
        }
        ...
        if ((isset($settings['button_text']) && !empty($settings['button_text'])) || (isset($settings['button_icon']) && !empty($settings['button_icon']['value']))) {
            ...
            $content_html .= '<a class="fmtpl-button-default fmtpl-writer-banner-button '.$btn_class.'" ' . $settings['link_attr_str'] . '>'.$settings['icon_str'].'<span class="fmtpl-btn-text">'.$settings['button_text'].'</span></a>';
        }

        if ($content_html != '') {
            $html .= '<div class="fmtpl-writer-banner-content">'.$content_html.'</div>';
        }
        $html .='</div>';
        return $html;
    }
