...
class Fmtpl_Products_Tabs extends Widget_Base{
    protected $default_control;

    public function get_name()
    {
        return 'fmtpl-products-tabs';
    }

    public function get_title()
    {
        return __('Products Tabs', 'fami-templatekits');
    }
    ...
    public function get_keywords() {
        return ['fami','fm', 'woocommerce', 'shop', 'store', 'product','products', 'tab', 'tabs' ];
    }
    ...
    public function __construct( $data = [], $args = null ) {
        ...
        $this->add_style_depends('fmtpl-products-tabs');
    }
...
sit amet consectetur adipiscing', 'fami-templatekits' ),
            ...
            'content_alignment' => [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs' => 'text-align: {{VALUE}}',
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-content' => 'text-align: {{VALUE}}',
                ],
            ],
            'title_bottom_space' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-tabs-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ],
            'title_color' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-tabs-title' => 'color: {{VALUE}};',
                ],
                'scheme' => [
            ...
            'title_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-tabs-title',
            ...
            'highlight_title_color' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-tabs-title .highlight' => 'color: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'highlight_title_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-tabs-title .highlight',
                'scheme' => Schemes\Typography::TYPOGRAPHY_1,
            ],
            ...
            'desc_bottom_space' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-desc' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ],
            'desc_color' => [
                'label' => __( 'Color', 'fami-templatekits' ),
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-desc' => 'color: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'desc_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-desc',
            ...
            'btn_width' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-button' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ...
            'btn_height' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-button' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ],
            ...
            'btn_color' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-button' => 'color: {{VALUE}};fill:  {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'btn_color_hover' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-button:hover' => 'color: {{VALUE}};fill: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'btn_bg_color' =>
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-button' => 'background-color: {{VALUE}};',
                    ],
                ],
            'btn_bg_color_hover' =>
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-button:hover' => 'background-color: {{VALUE}};',
                    ],
                ],
            'btn_border' => [
                'name' => 'btn_border',
                'label' => __( 'Border', 'fami-templatekits' ),
                'selector' => '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-button',
            ],
            ...
            'btn_border_radius' => [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ],
            'btn_border_color_hover' => [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-button:hover' => 'border-color: {{VALUE}};',
                ],
            ],
            'btn_icon_space' => [
                'label' => __( 'Spacing', 'fami-templatekits' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-button.left .fmtpl-btn-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-products-button.right .fmtpl-btn-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ...
            'btn_icon_size' =>  [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-btn-icon' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
                'condition' => ['button_icon[value]!' => '']
            ],
            'btn_icon_position' =>  [
            ...
            'btn_text_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-btn-text',
            ],
            //tab title style
            'tab_title_width' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link' => 'min-width: {{SIZE}}{{UNIT}};',
                ],
            ...
            'tab_title_alignment' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tabs-wrapper .nav-tabs' => '{{VALUE}};',
                ],
            ],
            'tab_title_color' => [
                'label' => __( 'Color', 'fami-templatekits' ),
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link' => 'color: {{VALUE}};fill: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'tab_title_hover_color' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link:hover' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link:hover svg' => 'fill: {{VALUE}};',
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link.active' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link.active svg' => 'fill: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'tab_title_bg_color' => [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link' => 'background-color: {{VALUE}};fill: {{VALUE}};',
                ],
            ],
            'tab_title_bg_hover_color' => [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link:hover,{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link.active' => 'background-color: {{VALUE}};',
                ],
            ],
            'tab_title_border' => [
                'name' => 'tab_title_border',
                'label' => __( 'Border', 'fami-templatekits' ),
                'selector' => '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tabs-wrapper .fmtpl-tab-link',
                'separator' => 'before',
            ],
            'list_item_border_radius' => [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tabs-wrapper .fmtpl-tab-link' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ],
            'tab_title_border_hover_color' => [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tabs-wrapper .fmtpl-tab-link:hover, {{WRAPPER}} .fmtpl-products-tabs .fmtpl-tabs-wrapper .fmtpl-tab-link.active' => 'border-color: {{VALUE}};',
                ],
                'condition' => [
            ...
            'tab_title_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link',
                'scheme' => Schemes\Typography::TYPOGRAPHY_4,
            ...
            'tab_icon_color' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link i' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link svg' => 'fill: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'tab_icon_color_hover' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link:hover i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link:hover svg' => 'fill: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
            ...
            'tab_icon_space' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .nav-tabs.left .fmtpl-tab-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .fmtpl-products-tabs .nav-tabs.top .fmtpl-tab-icon' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .fmtpl-products-tabs .nav-tabs.right .fmtpl-tab-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ],
            ...
            'tab_icon_size' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-icon *' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ...
            'tab_title_padding' => [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ],
            'tab_title_margin' => [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tab-link' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ],
            'tab_bottom_space' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-products-tabs .fmtpl-tabs-wrapper .nav-tabs' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ],
            'divider_width' => [
                'label' => __( 'Width', 'fami-templatekits' ),
        ...
        $this->default_control = apply_filters('fmtpl-products-tabs-elementor-widget-control', $widget_control);
    }
    protected function _register_controls()
    {
        ...
        if (isset($this->default_control['list_style'])) {
            $this->add_control(
                'list_style',
                $this->default_control['list_style']
            );
        }
        ...
        $this->start_controls_section(
            '_section_carousel',
            [
                'label' => __('Carousel', 'fami-templatekits'),
                'condition' => ['list_style' => 'carousel']
            ]
        );
        ...
        if (isset($this->default_control['space_between'])) {
            $this->add_responsive_control(
                'space_between',
                $this->default_control['space_between']
            );
        }
        if (isset($this->default_control['show_arrows'])) {
            $this->add_control(
                'show_arrows',
                $this->default_control['show_arrows']
            );
        }
        if (isset($this->default_control['pagination'])) {
            $this->add_control(
                'pagination',
                $this->default_control['pagination']
            );
        }
        if (isset($this->default_control['speed'])) {
            $this->add_control(
                'speed',
                $this->default_control['speed']
            );
        }
        if (isset($this->default_control['autoplay'])) {
            $this->add_control(
                'autoplay',
                $this->default_control['autoplay']
            );
        }
        if (isset($this->default_control['autoplay_speed'])) {
            $this->add_control(
                'autoplay_speed',
                $this->default_control['autoplay_speed']
            );
        }
        if (isset($this->default_control['loop'])) {
            $this->add_control(
                'loop',
                $this->default_control['loop']
            );
        }
        if (isset($this->default_control['pause_on_interaction'])) {
            $this->add_control(
                'pause_on_interaction',
                $this->default_control['pause_on_interaction']
            );
        }
        $this->end_controls_section();

        if (isset($this->default_control['next_icon']) || isset($this->default_control['prev_icon'])){
            $this->start_controls_section(
                '_section_arrow_icon',
                [
                    'label' => __( 'Arrow Icon', 'fami-templatekits' ),
                    'condition' => [
                        'list_style' => 'carousel',
                        'show_arrows' => 'yes',
                    ],
            ...
            if (isset($this->default_control['prev_icon'])) {
                $this->add_control(
                    'prev_icon',
                    $this->default_control['prev_icon']
                );
            }
            if (isset($this->default_control['next_icon'])) {
                $this->add_control(
                    'next_icon',
                    $this->default_control['next_icon']
                );
            }
            $this->end_controls_section();
        }
    ...
    protected function fmtpl_render() {
        ...
        if ((isset($settings['button_text']) && !empty($settings['button_text'])) || (!empty($settings['button_icon_str']))) {
            ...
            if ($ajaxload){
                ...
                $settings['link_attr_str'] .= ' data-pruducts-target=".tab-pane"';
            }

            $btn_html .= '<a class="fmtpl-button-default fmtpl-products-button '.$btn_class.'" ' . $settings['link_attr_str'] . '>'.$icon_str.'<span class="fmtpl-btn-text">'.$settings['button_text'].'</span></a>';
            if ($ajaxload){
                $btn_html .= '<span class="fmtpl_ajax_notice">'.esc_html__('All products have been loaded','fami-templatekits').'</span>';
            }
        }
        $settings['btn_html'] = $btn_html;
        $html = apply_filters('fmtpl-products-tabs-widget-html','',$settings);
        if (empty($html)){
            //check for old theme version
            $html = apply_filters('fmtpl-products-tabs-widget-control_html','',$settings);
        }
        if (!empty($html)){
            return $html;
        }
        ...
        $html = '<div class="fmtpl-elementor-widget fmtpl-products fmtpl-products-tabs fmtpl-products-tabs-layout-'.$layout.' woocommerce'.($tab_on_heading ? ' tab-heading':'').'">';
        $content_html = '';
        if (isset($settings['title_text']) && !empty($settings['title_text'])) {
            ...
            $content_html .= '<div class="fmtpl-widget-title fmtpl-products-tabs-title">'.$title.'</div>';
        }
        ...
        if (!empty($btn_html) && !$ajaxload){
            $content_html .= $btn_html;
        }
        ...
        if (isset($settings['tabs']) && !empty($settings['tabs'])) {
            ...
            $tab_html_nav = '';
            if ($content_html != '' && $tab_on_heading) {
                $tab_html_nav .= '<div class="fmtpl-products-content">'.$content_html.'</div>';
            }
            ...
            foreach ($settings['tabs'] as $tab){
                ...
                $data_string = '';
                if ($ajaxload){
                    $data_tmp_setting = fmtpl_get_products_elementor_settings($settings);
                    $data_tmp_setting2 = fmtpl_get_products_elementor_settings($tab);
                    $data_setting =  array_replace($data_tmp_setting,$data_tmp_setting2);
                    $data_string = ' data-settings ="'.urlencode(json_encode($data_setting)).'"';
                    $data_string .= ' data-page="1"';
                    if ($fmtpl_query->max_num_pages < 2){
                        $tab_class .= ' disabled_load';
                    }
                    $tab_content_html .= '<div class="fmtpl-products-button-wrapper">'.$btn_html.'</div>';
                }
                if ($tab_active){
                    $tab_class .= ' show active';
                }

                $tab_content .= sprintf('<div class="tab-pane fade%1$s" id="%2$s" role="tabpanel" aria-labelledby="%2$s-tab"%4$s>%3$s</div>',
                    $tab_class,
                    'fmtpl_tab_'.$tab['_id'],
                    $tab_content_html,
                    $data_string
        ...
        $html .= $tab_html;
        $html .= '</div><!--close fmtpl-products-tabs-->';
        return $html;
    }
}
