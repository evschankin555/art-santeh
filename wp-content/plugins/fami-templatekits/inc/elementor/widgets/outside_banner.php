...
class Fmtpl_Outside_Banner extends Widget_Base
{
    private $default_control;

    public function get_name()
    {
        return 'fmtpl-outside-banner';
    }

    public function get_title()
    {
        return __('Outside Banner', 'fami-templatekits');
    }
    ...
    public function get_keywords() {
        return ['fami','fm', 'image', 'photo', 'box', 'banner' ];
    }

    public function __construct( $data = [], $args = null ) {
        parent::__construct( $data, $args );
        $this->add_style_depends('fmtpl-outside-banner');
    }
    ...
    private function define_widget_control()
    {
        $widget_control = [
            ...
            'height' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ],
            'overlay' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner .fmtpl-outside-banner-overlay' => 'background-color: {{VALUE}};',
                ],
            ],
            'overlay_hover' => [
                'label' => __( 'Background Color', 'fami-templatekits' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner:hover .fmtpl-outside-banner-overlay' => 'background-color: {{VALUE}};',
                ],
            ],
            'image' => [
            ...
            'effect' => [
                ...
                'options' => [
                    ...
                    'gray_scale' => __('Gray', 'fami-templatekits'),
                    'overlay' => __('Overlay Style 1', 'fami-templatekits'),
                    'overlay2' => __('Overlay Style 2', 'fami-templatekits'),
                    'effect_border' => __('Border', 'fami-templatekits'),
                ],
            ],
            'title_text' =>
            [
...
sit amet consectetur adipiscing', 'fami-templatekits' ),
            ...
            'box_width' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-content' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ],
            'box_height' => [
                'label' => __( 'Height', 'fami-templatekits' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-content' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ],
            'content_alignment' => [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-content' => 'text-align: {{VALUE}}',
                ],
            ],
            'background_color' =>
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-content' => 'background-color: {{VALUE}};',
                ],
            ],
            ...
            'box_margin' => [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ],
            'box_padding' => [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ],
            ...
            'border' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-content',
            ],
            ...
            'border_radius' => [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ],
            ...
            'title_order' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-content .fmtpl-outside-banner-title' => 'order: {{VALUE}};',
                ],
            ],
            'title_bottom_space' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ],
            'title_color' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-title' => 'color: {{VALUE}};',
                ],
                'scheme' => [
            ...
            'title_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-title',
            ...
            'highlight_title_color' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-title .highlight' => 'color: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'highlight_title_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-title .highlight',
                'scheme' => Schemes\Typography::TYPOGRAPHY_1,
            ],
            ...
            'sub_title_color' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-sub-title' => 'color: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'sub_title_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-sub-title',
                'scheme' => Schemes\Typography::TYPOGRAPHY_1,
            ],
            'sub_title_order' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-content .fmtpl-sub-title' => 'order: {{VALUE}};',
                ],
            ],
            'sub_title_bottom_space' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-sub-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ],
            'desc_order' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-content .banner-desc' => 'order: {{VALUE}};',
                ],
            ],
            'desc_bottom_space' => [
                'label' => __( 'Spacing', 'fami-templatekits' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .banner-desc' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ],
            'desc_color' => [
                'label' => __( 'Color', 'fami-templatekits' ),
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .banner-desc' => 'color: {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'desc_typography' => [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-outside-banner-wrap .banner-desc',
            ...
            'btn_order' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-banner-btn-wrap' => 'order: {{VALUE}};',
                ],
            ],
            'btn_bottom_space' => [
                'label' => __( 'Spacing', 'fami-templatekits' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-banner-btn-wrap' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ],
            'btn_width' => [
                'label' => __( 'Width', 'fami-templatekits' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-button' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ],
            'btn_height' => [
                'label' => __( 'Height', 'fami-templatekits' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-button' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ],
            ...
            'btn_color' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-button' => 'color: {{VALUE}};fill:  {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'btn_color_hover' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-button:hover' => 'color: {{VALUE}};fill:  {{VALUE}};',
                ],
                'scheme' => [
                    'type' => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_1,
            ...
            'btn_bg_color' =>
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-button' => 'background-color: {{VALUE}};',
                    ],
                ],
            'btn_bg_color_hover' =>
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-button:hover' => 'background-color: {{VALUE}};',
                    ],
                ],
            'btn_border' => [
                'name' => 'btn_border',
                'label' => __( 'Border', 'fami-templatekits' ),
                'selector' => '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-button',
            ],
            ...
            'btn_border_radius' => [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ],
            'btn_border_color_hover' => [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-button:hover' => 'border-color: {{VALUE}};',
                ],
                'condition' => [
                    'btn_border_border!' => '',
                ],
            ...
            'divider_order' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-content .fmtpl-divider-wrap' => 'order: {{VALUE}};',
                ],
                'condition' => [
                    'show_divider' => 'yes'
                ]
            ...
            'divider_width' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-content .fmtpl-divider' => 'width: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'show_divider' => 'yes'
                ]
            ...
            'divider_height' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-content .fmtpl-divider' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'show_divider' => 'yes'
                ]
            ...
            'divider_color' => [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-content .fmtpl-divider' => 'background-color: {{VALUE}};',
                ],
                'default' => '#000000',
                'condition' => [
                    'show_divider' => 'yes'
            ...
            'divider_margin' => [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-content .fmtpl-divider' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'show_divider' => 'yes'
                ]
            ...
            'divider_border_type' => [
                ...
                'label' => __( 'Border', 'fami-templatekits' ),
                'selector' => '{{WRAPPER}} .fmtpl-outside-banner-content .fmtpl-divider',
                'condition' => [
                    'show_divider' => 'yes'
                ]
            ],
            ...
            'divider_border_radius' => [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-content .fmtpl-divider' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'show_divider' => 'yes'
                ]
            ...
            'divider_border_color_hover' => [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-content .fmtpl-divider:hover' => 'border-color: {{VALUE}};',
                ],
                'conditions' => [
                    'relation' => 'and',
                    'terms' => [
        ...
        $this->default_control = apply_filters('fmtpl-outside-banner-elementor-widget-control', $widget_control);
    }
    ...
    protected function _register_controls()
    {
        ...
        if (isset($this->default_control['sub_title_order'])) {
            $this->add_responsive_control(
                'sub_title_order',
                $this->default_control['sub_title_order']
            );
        }
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-button.left .fmtpl-btn-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-outside-banner-button.right .fmtpl-btn-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-btn-icon' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .fmtpl-outside-banner-wrap .fmtpl-btn-text',
            ]
        );
        $this->end_controls_section();
    }
    ...
    protected function fmtpl_render() {
        ...
        $html = apply_filters('fmtpl-outside-banner-elementor-widget-html','',$settings);
        if (empty($html)){
            //check for old theme version
            $html = apply_filters('fmtpl-outside-banner-elementor-widget-control_html','',$settings);
        }
        if (!empty($html)){
            return $html;
        }
        $html = '<div class="fmtpl-outside-banner-wrap '.$settings['layout'].'"><div class="fmtpl-elementor-widget fmtpl-outside-banner">';
        if ( ! empty( $style_str ) ) {
            $effect_class = isset($settings['effect']) ? $settings['effect'] : 'zoom';
            $html .= '<div class="fmtpl-outside-banner-background '.$effect_class.'" '.$style_str.'></div>';
        }

        if (isset($settings['overlay']) && !empty($settings['overlay']) || (isset($settings['overlay_hover']) && !empty($settings['overlay_hover']))) {
            $html .= '<div class="fmtpl-outside-banner-overlay"></div>';
        }
        if ($settings['image_html'] != ''){
            if ($settings['link_attr_str'] != ''){
                $html .= '<figure class="fmtpl-outside-banner-box-img has-link"><a class="banner-img-link" '.$settings['link_attr_str'].'>' . $settings['image_html'] . '</a></figure>';
            } else {
                $html .= '<figure class="fmtpl-outside-banner-box-img">' . $settings['image_html'] . '</figure>';
            }
        }
        $content_html = '';
        ...
        if (isset($settings['title_text'])) {
            ...
            $content_html .= '<div class="fmtpl-widget-title fmtpl-outside-banner-title ">'.$title.'</div>';
        }
        if (isset($settings['show_divider']) && $settings['show_divider'] == 'yes'){
            $content_html .= '<div class="fmtpl-divider-wrap"><div class="fmtpl-divider">&nbsp;</div></div>';
        }
        ...
        if ((isset($settings['button_text']) && !empty($settings['button_text'])) || (isset($settings['button_icon']) && !empty($settings['button_icon']['value']))) {
            ...
            $content_html .= '<div class="fmtpl-banner-btn-wrap"><a class="fmtpl-button-default fmtpl-outside-banner-button '.$btn_class.'" ' . $settings['link_attr_str'] . '>'.$settings['icon_str'].'<span class="fmtpl-btn-text">'.$settings['button_text'].'</span></a></div>';
        }
        $html .='</div>';
        if ($content_html != '') {
            $html .= '<div class="fmtpl-outside-banner-content">'.$content_html.'</div>';
        }
        $html .='</div>';
        return $html;
    }
